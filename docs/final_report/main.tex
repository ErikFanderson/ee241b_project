...
analyze the area benefits of a vertical relay FPG, and lay the groundwork for future power/performance analysis. 
A (rFPGA) architecture relative to the traditional CMOS-only FPGA. Our designs will use ASAP7 \cite{clark_asap7_2016} 
