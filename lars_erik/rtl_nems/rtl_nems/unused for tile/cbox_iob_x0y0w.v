...
module cbox_iob_x0y0w (
    ...
    output wire [19:0] cbo_L1_u1y0n,
    output wire [19:0] cbo_L1_u1y0s,
    ...
    cfg_mux10 sw_blkp_iob_x0y0_0_outpad_0 (
        .i({cbi_L1_u1y0s[8], cbi_L1_u1y0n[8], cbi_L1_u1y0s[6], cbi_L1_u1y0n[6], cbi_L1_u1y0s[4], cbi_L1_u1y0n[4], cbi_L1_u1y0s[2], cbi_L1_u1y0n[2], cbi_L1_u1y0s[0], cbi_L1_u1y0n[0]}),
        .o(sw_blkp_iob_x0y0_0_outpad_0__o),
        .cfg_d(cfg_d[3:0])
        );
    cfg_mux10 sw_blkp_iob_x0y0_1_outpad_0 (
        .i({cbi_L1_u1y0s[12], cbi_L1_u1y0n[12], cbi_L1_u1y0s[10], cbi_L1_u1y0n[10], cbi_L1_u1y0s[8], cbi_L1_u1y0n[8], cbi_L1_u1y0s[6], cbi_L1_u1y0n[6], cbi_L1_u1y0s[4], cbi_L1_u1y0n[4]}),
        .o(sw_blkp_iob_x0y0_1_outpad_0__o),
        .cfg_d(cfg_d[7:4])
        );
    cfg_mux10 sw_blkp_iob_x0y0_2_outpad_0 (
        .i({cbi_L1_u1y0s[16], cbi_L1_u1y0n[16], cbi_L1_u1y0s[14], cbi_L1_u1y0n[14], cbi_L1_u1y0s[12], cbi_L1_u1y0n[12], cbi_L1_u1y0s[10], cbi_L1_u1y0n[10], cbi_L1_u1y0s[8], cbi_L1_u1y0n[8]}),
        .o(sw_blkp_iob_x0y0_2_outpad_0__o),
        .cfg_d(cfg_d[11:8])
        );
    cfg_mux10 sw_blkp_iob_x0y0_3_outpad_0 (
        .i({cbi_L1_u1y0s[1], cbi_L1_u1y0n[1], cbi_L1_u1y0s[18], cbi_L1_u1y0n[18], cbi_L1_u1y0s[16], cbi_L1_u1y0n[16], cbi_L1_u1y0s[14], cbi_L1_u1y0n[14], cbi_L1_u1y0s[12], cbi_L1_u1y0n[12]}),
        .o(sw_blkp_iob_x0y0_3_outpad_0__o),
        .cfg_d(cfg_d[15:12])
        );
    cfg_mux10 sw_blkp_iob_x0y0_4_outpad_0 (
        .i({cbi_L1_u1y0s[5], cbi_L1_u1y0n[5], cbi_L1_u1y0s[3], cbi_L1_u1y0n[3], cbi_L1_u1y0s[1], cbi_L1_u1y0n[1], cbi_L1_u1y0s[18], cbi_L1_u1y0n[18], cbi_L1_u1y0s[16], cbi_L1_u1y0n[16]}),
        .o(sw_blkp_iob_x0y0_4_outpad_0__o),
        .cfg_d(cfg_d[19:16])
        );
    cfg_mux10 sw_blkp_iob_x0y0_5_outpad_0 (
        .i({cbi_L1_u1y0s[9], cbi_L1_u1y0n[9], cbi_L1_u1y0s[7], cbi_L1_u1y0n[7], cbi_L1_u1y0s[5], cbi_L1_u1y0n[5], cbi_L1_u1y0s[3], cbi_L1_u1y0n[3], cbi_L1_u1y0s[1], cbi_L1_u1y0n[1]}),
        .o(sw_blkp_iob_x0y0_5_outpad_0__o),
        .cfg_d(cfg_d[23:20])
        );
    cfg_mux10 sw_blkp_iob_x0y0_6_outpad_0 (
        .i({cbi_L1_u1y0s[13], cbi_L1_u1y0n[13], cbi_L1_u1y0s[11], cbi_L1_u1y0n[11], cbi_L1_u1y0s[9], cbi_L1_u1y0n[9], cbi_L1_u1y0s[7], cbi_L1_u1y0n[7], cbi_L1_u1y0s[5], cbi_L1_u1y0n[5]}),
        .o(sw_blkp_iob_x0y0_6_outpad_0__o),
        .cfg_d(cfg_d[27:24])
        );
    cfg_mux10 sw_blkp_iob_x0y0_7_outpad_0 (
        .i({cbi_L1_u1y0s[17], cbi_L1_u1y0n[17], cbi_L1_u1y0s[15], cbi_L1_u1y0n[15], cbi_L1_u1y0s[13], cbi_L1_u1y0n[13], cbi_L1_u1y0s[11], cbi_L1_u1y0n[11], cbi_L1_u1y0s[9], cbi_L1_u1y0n[9]}),
        .o(sw_blkp_iob_x0y0_7_outpad_0__o),
        .cfg_d(cfg_d[31:28])
        );
    cfg_mux10 sw_blkp_iob_x0y0_8_outpad_0 (
        .i({cbi_L1_u1y0s[2], cbi_L1_u1y0n[2], cbi_L1_u1y0s[19], cbi_L1_u1y0n[19], cbi_L1_u1y0s[17], cbi_L1_u1y0n[17], cbi_L1_u1y0s[15], cbi_L1_u1y0n[15], cbi_L1_u1y0s[13], cbi_L1_u1y0n[13]}),
        .o(sw_blkp_iob_x0y0_8_outpad_0__o),
        .cfg_d(cfg_d[35:32])
        );
    cfg_mux10 sw_blkp_iob_x0y0_9_outpad_0 (
        .i({cbi_L1_u1y0s[6], cbi_L1_u1y0n[6], cbi_L1_u1y0s[4], cbi_L1_u1y0n[4], cbi_L1_u1y0s[2], cbi_L1_u1y0n[2], cbi_L1_u1y0s[19], cbi_L1_u1y0n[19], cbi_L1_u1y0s[17], cbi_L1_u1y0n[17]}),
