...
module io_tile_east (
    ...
    output wire [19:0] arc_L1_u1y0n,
    output wire [19:0] arc_L1_u1y0s,
    ...
    wire [19:0] cbinst_x0y0w__cbo_L1_u1y0n;
    wire [19:0] cbinst_x0y0w__cbo_L1_u1y0s;
    ...
    cbox_iob_x0y0w cbinst_x0y0w (
        ...
        .cbo_L1_u1y0n(cbinst_x0y0w__cbo_L1_u1y0n),
        .cbo_L1_u1y0s(cbinst_x0y0w__cbo_L1_u1y0s),
    ...
    assign arc_L1_u1y0n = cbinst_x0y0w__cbo_L1_u1y0n;
    assign arc_L1_u1y0s = cbinst_x0y0w__cbo_L1_u1y0s;
